...
function getCID(content, wrapWithDirectory = true, cidVersion = 0) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let lastCid;
        try {
            for (var _b = __asyncValues(importer(content, dummyBlockstore, options)), _c; _c = yield _b.next(), !_c.done;) {
                const { cid } = _c.value;
                lastCid = cid;
            }
        }
...
export { DEFAULT_GATEWAY_URLS, IpfsUploader, PINATA_IPFS_URL, StorageDownloader, TW_IPFS_SERVER_URL, ThirdwebStorage, extractObjectFiles, getBuffer, getCID, getCIDForUpload, isBrowser, isBufferInstance, isBufferOrStringWithName, isFileBufferOrStringEqual, isFileInstance, isFileOrBuffer, isUploaded, parseGatewayUrls, prepareGatewayUrls, replaceGatewayUrlWithScheme, replaceObjectFilesWithUris, replaceObjectGatewayUrlsWithSchemes, replaceObjectSchemesWithGatewayUrls, replaceSchemeWithGatewayUrl };
